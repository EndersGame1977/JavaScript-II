...
ticketPriceTotal = runners.reduce((accumulater, runner) => accumulater + runner.donation, 0);
...
// Problem 1
// Avarage amount donated.
let averageDonnated = [];
averageDonnated = runners.reduce((accumulater, runner) => accumulater + runner.donation, 0);
averageDonnated /= runners.length;
console.log(`The average amount donated was $${averageDonnated}`);

// Problem 2
// Donated $100 or more.
let largeDonation = [];
largeDonation = runners.filter(runner => runner.donation >= 100);
console.log(`The runners who had a donation of $100 or more are: ${largeDonation}`);


// Problem 3
// Number of runner who wear size small.
let sizeSmall = [];
sizeSmall = runners.filter(runner => runner.shirt_size === "S");
sizeSmall = sizeSmall.length;
console.log(`There are a total of ${sizeSmall} who wear size small.`);